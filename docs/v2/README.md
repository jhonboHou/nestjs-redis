...
[![npm (tag)](https://img.shields.io/npm/v/@jhonbohou/nestjs-redis/latest?style=flat-square)](https://www.npmjs.com/package/@jhonbohou/nestjs-redis)
[![npm (scoped with tag)](https://img.shields.io/npm/v/@jhonbohou/nestjs-redis/next?style=flat-square)](https://www.npmjs.com/package/@jhonbohou/nestjs-redis/v/3.0.0-next.2)
![npm](https://img.shields.io/npm/dw/@jhonbohou/nestjs-redis?style=flat-square)
[![GitHub](https://img.shields.io/github/license/jhonbohou/nestjs-redis?style=flat-square)](https://github.com/jhonbohou/nestjs-redis/blob/main/LICENSE)
[![code style: prettier](https://img.shields.io/badge/code_style-prettier-ff69b4.svg?style=flat-square)](https://github.com/prettier/prettier)
[![CodeFactor](https://www.codefactor.io/repository/github/jhonbohou/nestjs-redis/badge)](https://www.codefactor.io/repository/github/jhonbohou/nestjs-redis)
[![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-green.svg)](https://github.com/jhonbohou/nestjs-redis/graphs/commit-activity)
...
```sh
$ npm install --save @jhonbohou/nestjs-redis@next ioredis @nestjs/terminus@next
$ npm install --save-dev @types/ioredis
```

```sh
$ yarn add @jhonbohou/nestjs-redis@next ioredis @nestjs/terminus@next
...
```sh
$ npm install --save @jhonbohou/nestjs-redis@2 ioredis @nestjs/terminus@7
$ npm install --save-dev @types/ioredis
```

```sh
$ yarn add @jhonbohou/nestjs-redis@2 ioredis @nestjs/terminus@7
$ yarn add --dev @types/ioredis
```
...
import { InjectRedis, DEFAULT_REDIS_CLIENT } from '@jhonbohou/nestjs-redis';
...
import { Injectable } from '@nestjs/common';
import { Redis } from 'ioredis';
import { DEFAULT_REDIS_CLIENT, RedisService } from '@jhonbohou/nestjs-redis';
...
import { RedisHealthIndicator, DEFAULT_REDIS_CLIENT } from '@jhonbohou/nestjs-redis';
...
import { InjectCluster, DEFAULT_CLUSTER_CLIENT } from '@jhonbohou/nestjs-redis';
...
import { Injectable } from '@nestjs/common';
import { Cluster } from 'ioredis';
import { DEFAULT_CLUSTER_CLIENT, ClusterService } from '@jhonbohou/nestjs-redis';
...
import { Controller, Get } from '@nestjs/common';
import { HealthCheckService, HealthCheckResult } from '@nestjs/terminus';
import { ClusterHealthIndicator, DEFAULT_CLUSTER_CLIENT } from '@jhonbohou/nestjs-redis';
...
- Website: https://github.com/jhonbohou
- Github: [@jhonbohou](https://github.com/jhonbohou)

## 🤝 Contributing

Contributions, issues and feature requests are welcome!

Feel free to check [issues page](https://github.com/jhonbohou/nestjs-redis/issues).
...
Copyright © 2021 [LiaoLiao](https://github.com/jhonbohou).

This project is [MIT](https://github.com/jhonbohou/nestjs-redis/blob/main/LICENSE) licensed.
