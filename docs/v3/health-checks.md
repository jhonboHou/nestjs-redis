...
import { ClusterModule, RedisModule } from '@jhonbohou/nestjs-redis';
import { RedisHealthModule } from '@jhonbohou/nestjs-redis/health'; // note the import path
...
import { InjectRedis, InjectCluster } from '@jhonbohou/nestjs-redis';
import { RedisHealthIndicator } from '@jhonbohou/nestjs-redis/health'; // note the import path
