...
<div align="center">
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/jhonbohou/nestjs-redis/issues">Report Bug</a>
    ·
...
```sh
# with npm
npm install @nestjs/terminus @jhonbohou/nestjs-redis-health ioredis
# with yarn
yarn add @nestjs/terminus @jhonbohou/nestjs-redis-health ioredis
# with pnpm
pnpm add @nestjs/terminus @jhonbohou/nestjs-redis-health ioredis
```
...
import { RedisHealthModule } from '@jhonbohou/nestjs-redis-health';
...
import { RedisHealthIndicator } from '@jhonbohou/nestjs-redis-health';
...
[npm-shield]: https://img.shields.io/npm/v/@jhonbohou/nestjs-redis-health/latest?style=for-the-badge
[npm-url]: https://www.npmjs.com/package/@jhonbohou/nestjs-redis-health
[downloads-shield]: https://img.shields.io/npm/dm/@jhonbohou/nestjs-redis-health?style=for-the-badge
[downloads-url]: https://www.npmjs.com/package/@jhonbohou/nestjs-redis-health
...
[vulnerabilities-shield]: https://img.shields.io/snyk/vulnerabilities/npm/@jhonbohou/nestjs-redis-health?style=for-the-badge
